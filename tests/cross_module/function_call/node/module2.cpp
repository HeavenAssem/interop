...
namespace mosaic {
    ...
    void _mosaic_module_initialize(module_context & context) {
        ...
        try {
            context.get("module1").function("hello_world")->call(15, 4.5f, 7.0);

            context.get("module1").function("hello_world")->call(8, 2.5f, 100.8);

            context.get("module1").function("add")->call(10, 14);
